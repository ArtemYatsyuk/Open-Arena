...
export default function SettingsModal({ isOpen, onClose }: SettingsModalProps) {
    ...
    >
      ...
      >
        ...
        <div className="flex items-center justify-between p-5 border-b border-border">
          ...
          <button onClick={onClose} className="p-2 hover:bg-bg-secondary rounded-xl transition">
            <X className="w-5 h-5" />
          </button>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <span className="text-xs text-text-secondary/50 group-hover:text-accent transition">
                    &rarr;
                  </span>
                </a>
              </div>
              ...
              <div className="flex-1 overflow-y-auto p-5 space-y-8 text-sm leading-relaxed">
                <section id="docs-getting-started">
                  ...
                  <p className="text-text-secondary mb-2">
                    Open Arena is a multi-model AI chat platform. You can switch between AI models,
                    toggle web search for real-time information, browse conversation history, and
                    manage everything from a clean interface.
                  </p>
                  <p className="text-text-secondary mb-2">
                    To get started, <strong>log in</strong> or <strong>register</strong> an account.
                    Once logged in, you'll see the chat interface with a sidebar for conversation
                    management and a main area for chatting.
                  </p>
                  <p className="text-text-secondary">
                    The sidebar shows your conversations grouped by date. Click any conversation to
                    open it, or click <strong>+ New conversation</strong> to start fresh.
                  </p>
                </section>
                ...
                <section id="docs-chat-basics">
                  ...
                  <ul className="space-y-1.5 text-text-secondary list-disc list-inside">
                    <li>
                      <strong>Send a message</strong> &mdash; type in the input box and press Enter
                    </li>
                    <li>
                      <strong>New line</strong> &mdash; press Shift + Enter
                    </li>
                    <li>
                      <strong>New conversation</strong> &mdash; click the + button in the sidebar or
                      press Ctrl + K
                    </li>
                    <li>
                      <strong>Switch models</strong> &mdash; use the dropdown above the chat input
                    </li>
                    <li>
                      <strong>Regenerate</strong> &mdash; click the ↻ icon below any AI response to
                      re-generate it. Multiple versions are preserved &mdash; use the{' '}
                      <code>‹ 1/2 ›</code> arrows to navigate between them.
                    </li>
                    <li>
                      <strong>Toggle sidebar</strong> &mdash; press Ctrl + / or click the hamburger
                      menu
                    </li>
                    <li>
                      <strong>Copy response</strong> &mdash; hover over a message and click the Copy
                      button
                    </li>
                  </ul>
                </section>
                ...
                <section id="docs-web-search">
                  ...
                  <p className="text-text-secondary mb-2">
                    Open Arena can search the web in real-time before the AI responds. Toggle the{' '}
                    <Globe className="w-3.5 h-3.5 inline" /> icon next to the input to enable web
                    search for your next message. The feature uses a SearXNG instance (configurable
                    in <code>config.json</code>).
                  </p>
                  <p className="text-text-secondary mb-2">When web search is active:</p>
                  <ul className="space-y-1.5 text-text-secondary list-disc list-inside mb-2">
                    ...
                    <li>
                      The AI can reference sources using <code>[1]</code>, <code>[2]</code>{' '}
                      notation, which become clickable links
                    </li>
                  </ul>
                  <p className="text-text-secondary">
                    If the search service is unreachable, a fallback message with today's date is
                    injected so the model still has current context.
                  </p>
                </section>
                ...
                <section id="docs-custom-models">
                  ...
                  <p className="text-text-secondary mb-2">
                    Models are defined in <code>config.json</code> at the project root. Each model
                    entry specifies the API endpoint, authentication, and capabilities. You can add
                    models from OpenAI, OpenRouter, or any OpenAI-compatible API.
                  </p>
  ...
  "description": "My custom model"
                  ...
                  <p className="text-text-secondary mb-2">To add a model:</p>
                  <ol className="space-y-1.5 text-text-secondary list-decimal list-inside mb-2">
                    <li>
                      Go to <strong>Admin Panel → Config</strong>
                    </li>
                    <li>
                      Add the model entry in the JSON editor or use the <strong>Add Model</strong>{' '}
                      form
                    </li>
                    <li>
                      Set the <code>apiKeyEnv</code> to the environment variable name that holds the
                      API key
                    </li>
                    <li>
                      Click <strong>Save Configuration</strong> and the model will appear in the
                      dropdown
                    </li>
                  </ol>
                  <p className="text-text-secondary">
                    The <code>baseUrl</code> and <code>endpoint</code> are joined to form the full
                    API URL. For OpenAI-compatible APIs, use <code>/chat/completions</code> as the
                    endpoint.
                  </p>
                </section>
                ...
                <section id="docs-filters">
                  ...
                  <p className="text-text-secondary mb-2">
                    Filters are JavaScript modules that run in a sandboxed Node.js VM on every chat
                    request. Each filter can export an <code>inlet</code> function (runs{' '}
                    <em>before</em> the AI responds) and an <code>outlet</code> function (runs{' '}
                    <em>after</em>). Use them for rate limiting, content moderation, logging,
                    analytics, or transforming requests/responses.
                  </p>
  ...
  outlet: (body, user) => {
    ...
    return body;
                  ...
                  <p className="text-text-secondary mb-1">
                    Blocks a user after 1 message (uses <code>globalThis</code> for persistent
                    state):
                  </p>
                  <pre className="bg-bg-secondary border border-border rounded-xl p-4 overflow-x-auto text-xs font-mono">
                    {`module.exports = {
  ...
  outlet: (body, user) => body,
                  ...
                  <ol className="space-y-1.5 text-text-secondary list-decimal list-inside">
                    <li>
                      Go to <strong>Admin Panel → Filters</strong>
                    </li>
                    <li>
                      Click <strong>New Filter</strong>
                    </li>
                    <li>
                      Give it a name, priority (lower runs first), and paste your JavaScript code
                    </li>
                    <li>
                      Click <strong>Test</strong> to validate the code compiles, then{' '}
                      <strong>Save</strong>
                    </li>
                    <li>
                      Toggle the filter <strong>Active</strong> to enable it for all chat requests
                    </li>
                  </ol>
                  <p className="text-text-secondary mt-2">
                    If the <code>inlet</code> function throws an error, the chat request is rejected
                    and the user sees the error message. Use this for blocking unwanted requests.
                  </p>
                </section>
                ...
                <section id="docs-reasoning">
                  ...
                  <p className="text-text-secondary mb-2">
                    Some AI models support <strong>reasoning</strong> (also called thinking or
                    chain-of-thought). This is an internal monologue where the model works through a
                    problem before producing its final answer.
                  </p>
                  <p className="text-text-secondary mb-2">
                    Reasoning is displayed in a collapsible amber <strong>Thinking Process</strong>{' '}
                    section above the response. During generation, it updates in real-time. After
                    completion, it collapses by default.
                  </p>
                  <p className="text-text-secondary mb-2">
                    To control this feature, use the <Brain className="w-3.5 h-3.5 inline" /> toggle
                    next to the chat input. When enabled (default), the AI will include reasoning in
                    its responses if the model supports it. When disabled, reasoning is not
                    requested and only the final answer is shown.
                  </p>
                  <p className="text-text-secondary">
                    Not all models support reasoning. Models from providers like NVIDIA NIM,
                    DeepSeek, and some OpenAI models expose a <code>reasoning_content</code> field
                ...
                <section id="docs-admin">
                  ...
                  <p className="text-text-secondary mb-2">
                    Users with the <strong>ADMIN</strong> role can access the admin panel via the{' '}
                    <code>Layers</code> icon in the sidebar footer. The panel includes:
                  </p>
                  <ul className="space-y-1.5 text-text-secondary list-disc list-inside">
                    <li>
                      <strong>Dashboard</strong> &mdash; usage stats: total users, active today,
                      conversation count, messages per day chart
                    </li>
                    <li>
                      <strong>Users</strong> &mdash; manage accounts, assign USER/ADMIN roles,
                      ban/unban with reason, view conversation counts
                    </li>
                    <li>
                      <strong>Conversations</strong> &mdash; browse all user conversations with
                      search, pagination, and an inline message viewer using ReactMarkdown
                    </li>
                    <li>
                      <strong>Config</strong> &mdash; edit the server <code>config.json</code> in a
                      JSON editor, add/remove models via a form, create timestamped backups
                    </li>
                    <li>
                      <strong>Filters</strong> &mdash; create, edit, test, and manage JavaScript
                      filters that hook into every chat request
                    </li>
                  </ul>
                </section>
              ...
              <div>
                ...
                <div className="p-4 bg-bg-secondary rounded-xl">
                  <p className="text-sm text-text-secondary mb-3">
                    Clear all locally stored preferences and cached data. This won't affect your
                    conversations or account.
                  </p>
                  <button
